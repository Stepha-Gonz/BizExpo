...
class PonentesController
{
    ...
    public static function editar(Router $router)
    {
        ...
        if (!$ponente) {
            echo json_encode(['status' => 'error', 'message' => 'Ponente no encontrado']);
            exit();
        }
    ...
    public static function eliminar()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($resultado) {
                echo json_encode(['status' => 'success', 'message' => 'Ponente eliminado correctamente']);
            } else {
                echo json_encode(['status' => 'error', 'message' => 'No se pudo eliminar el ponente']);
            }
            exit();
        }
    }
